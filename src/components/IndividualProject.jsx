...
export const IndividualProject = () => {
  ...
  const projects = [
    { id: 1, name: "AutoSprink", img: AutoSprink, demo: 'https://autosprink.com/', code: 'https://github.com/mepcad-ransay', desc: 'Multiple web based apps that utilized MithrilJS, a React like front end'},
    ...
    { id: 5, name: "NamePass", img: NamePass, demo: 'https://theresaqueryforthat.github.io/namepass/', code: 'https://github.com/theresaqueryforthat/namepass', desc: 'A basic version of NamePassPro' },
    { id: 6, name: "Employee Tracker", img: EmployeeTracker, demo: '#', code: 'https://github.com/RickyRicer/employeeTracker', desc: 'An app that utilizes the CLI, SQL, and express to create an employee database'},
