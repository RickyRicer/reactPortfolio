  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <h2 className="text-4xl sm:text-7xl font-bold text-[#8892b0]"><Typewriter options={{strings: ["I'm a Full Stack Developer.", "I'm a problem solver.", "I'm a scuba diver.", "I'm crazy about NFTs."], autoStart: true, loop: true}} /></h2>
