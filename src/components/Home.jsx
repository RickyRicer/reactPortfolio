  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <p className="text-[#8892b0] py-4 max-w-[700px]">{("Welcome to my portfolio. I look forward to helping you achieve your next project's goal! I'm always challenging myself to learn new things!")}</p>
            <div>
